...
def install_layer(layer_id: str):
    ...
    try:
        response = requests.post(
            '{host}/geoserver/rest/workspaces/{ws}/datastores/{ds}/featuretypes'.format(  # FIXME -- https please?
                host=GEOSERVER_HOST,
...
def install_style(style_id: str):
    ...
    try:
        response = requests.post(
            '{}/geoserver/rest/styles'.format(  # FIXME -- https please?
                GEOSERVER_HOST,
            ),
            data="""
        ...
        response = requests.put(
            '{}/geoserver/rest/layers/{}'.format(  # FIXME -- https please?
                GEOSERVER_HOST,
                DETECTIONS_LAYER_ID,
            ),
            data="""
