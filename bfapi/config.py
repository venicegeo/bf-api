...
GEOSERVER_HOST = _services.get('pz-geoserver-efs.geoserver.credentials.host')
GEOSERVER_USERNAME = _services.get('pz-geoserver-efs.geoserver.credentials.username')
GEOSERVER_PASSWORD = _services.get('pz-geoserver-efs.geoserver.credentials.password')
