...
INSERT INTO scene (scene_id, acquired_on, cloud_cover, geometry, resolution, sensor_name, catalog_uri)
...
VALUES ('J0001', 'NDWI', '13', 'dave', 'D0001', 'FIXTURE_ONE', 'landsat:LC80070682016272LGN00', 'Success'),
       ('J0002', 'NDWI', '13', 'dave', NULL, 'FIXTURE_TWO', 'landsat:LC80070682016272LGN00', 'Running'),
       ('J0003', 'NDWI', '13', 'dave', 'D0002', 'FIXTURE_THREE', 'landsat:LC80070672016272LGN00', 'Success'),
       ('J0004', 'NDWI', '13', 'dave', NULL, 'FIXTURE_FOUR', 'landsat:LC80070662016272LGN00', 'Error'),
       ('J0005', 'NDWI', '13', 'dave', NULL, 'FIXTURE_FIVE', 'landsat:LC80070652016272LGN00', 'Error'),
       ('J0006', 'NDWI', '13', 'dave', NULL, 'FIXTURE_SIX', 'landsat:LC80070652016272LGN00', 'Error');
