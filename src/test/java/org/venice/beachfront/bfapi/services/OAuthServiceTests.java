...
public class OAuthServiceTests {
	...
	public void testRequestAccessTokenSuccess() throws UserException {
		...
		Mockito.when(this.restTemplate.exchange(
				Mockito.eq(this.oauthTokenUrl), Mockito.eq(HttpMethod.POST), Mockito.any(), Mockito.eq(AccessTokenResponseBody.class))
	...
	public void testRequestOAuthProfileSuccess() throws UserException {
		...
		Mockito.when(this.restTemplate.exchange(
				Mockito.eq(this.oauthProfileUrl), Mockito.eq(HttpMethod.GET), Mockito.any(), Mockito.eq(ProfileResponseBody.class))
			).then(new Answer<ResponseEntity<ProfileResponseBody>>() {
			@Override
