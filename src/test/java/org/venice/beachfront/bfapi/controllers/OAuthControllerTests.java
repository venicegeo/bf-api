...
public class OAuthControllerTests {
	...
	public void testCallback() throws UserException {
		...
		ProfileResponseBody mockProfileResponse = new ProfileResponseBody("dn", new AbstractStringList.SingleString("common"), new AbstractStringList.SingleString("member"), null, null, null);
